                ...
                <div class="max-w-3xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
                    <div class="p-6">
                        ...
                        <div class="flex justify-center">
                            <a href="{{ route('quiz.start') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-md text-lg transition-colors duration-200 shadow-md">Get Started</a>
                        </div>
                    </div>
                </div>
            </div>
