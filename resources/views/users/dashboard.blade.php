...
<div class="min-h-full">
  ...
  <main>
    <div class="flex-shrink-0 ml-4">
        <a href="{{ route('questions.index') }}" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">View Question</a>
      </div>
      <div class="flex-shrink-0 ml-4">
        <a href="{{ route('questions.create') }}" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Add Question</a>
      </div>
  </main>
</div>
